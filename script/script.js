...
// Função desenvolvida para alterar a cor do elemento se ele for válido
function valid(element){
    element.style.color = "#202040"
}

// Função desenvolvida para alterar a cor do elemento se ele for inválido
function invalid(element, otherElement){
    element.style.color = "#f04624";
    otherElement.value = 0;
}

// Função desenvolvida para RGB
function paraRgb(){
